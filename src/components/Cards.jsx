  ...
  return (
    <div className='w-full py-[10rem] px-4 bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        <div className='bg-green-100 w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-200'>
          <img
        ...
        <div className='bg-gray-200 w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-200'>
          <img
            className='w-20 mx-auto mt-[-3rem] bg-transparent'
            src={Double}
            alt='/'
